              ...
              <table class="table">
                ...
                <tbody>
                  <?php
                    ...
                    <td> <img src=" images2/<?php echo $row->img;?>" height="100px" width="100px" ></td>
                    <td><a href="catedit.php?editid=<?php echo $row->id;?>">Edit</a></td>
                    <td><a href="catdelete.php?delid=<?php echo $row->id;?>">Delete</a></td>
                  </tr>
                  <?php
                    }
                  ?>
