    ...
    <section class="section">
      <div class="row offset-md-2 mt-5">
        <div class="col-lg-8 ">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center">SUB CATEGORIES</h5>
              ...
              <table class="table">
                ...
                <tbody>
                  <?php
                    ...
                    <td><a href="subcatedit.php?editid=<?php echo $row->id;?>">Edit</a></td>
                    <td><a href="subcatdel.php?delid=<?php echo $row->id;?>">Delete</a></td>
                  </tr>
                  <?php
                    }
                  ?>
