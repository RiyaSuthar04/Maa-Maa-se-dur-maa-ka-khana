<?php
  ...
  $exe=$conn->query("select * from feedback");
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row offset-md-2 mt-5 mx-auto">
        <div class="col-lg-12 ">

          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center">User Feedback</h5>
              ...
              <table class="table">
                ...
                <tbody>
                  <?php
                    ...
                    <td><?php echo $row->overall_experience;?></td>
