<?php
  ...
  $id= $_GET["editid"];
  $result= $conn->query("select * from subcat where id='$id'");
  $row=$result->fetch_object();
  if(isset($_POST['submit']))
  {
    $subcat=$_POST["subcat"];
    $cat=$_POST["cat"];
    $exe= $conn->query("update subcat set subcat_name='$subcat' where id='$id'");
    if($exe)
    {
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-8 offset-md-2">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center">ADD SUB-CATEGORIES</h5>

              <!-- Multi Columns Form -->
              <form class="row g-3" method="post">
                <div class="col-md-8">
                  <label for="inputName5" class="form-label">Sub-Category Name</label>
                  <input type="text" class="form-control" id="inputName5" name="subcat" value="<?php echo $row->subcat_name;?>">
                </div>
