...
if (isset($_POST['submit'])) {
	...
	$exe = $conn->query("insert into cart2(product,price,quantity,img,agency_id,cid)values('$fname','$price','$quantity','$img','$agency_id','$uid')");
	if ($exe) {
													...
													<li>
														<div class="input-group mb-3">
															...
															<div class="input-group-append">
																...
																value="Order"class="btn btn-primary">
															</div>
															<div class="input-group-append">
