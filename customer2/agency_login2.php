<?php
    ...
    if(isset($_POST['submit']))
    {
		...
		$result = $conn->query("select * from tiffin_service where email='$email' and password='$password'");
       	 $rowcount= $result->num_rows;
        	if($rowcount == 1)
        	{
          		$row= $result->fetch_object();
          		$_SESSION['id']=$row->tiffin_agency_name;
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-12 col-md-12 col-sm-12">
							<div class="text-center">
								<h2 class="breadcrumbs_title">Agency Login</h2>
								...
								<form method="post">
									...
									<div class="login_flex">
										<div class="login_flex_1">
											<a href="tiffin_reg.php" class="text-bold">Don't Have Account?</a>
										</div>
