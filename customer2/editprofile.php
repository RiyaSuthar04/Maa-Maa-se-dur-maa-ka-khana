...
if(isset($_POST['edit']))
{
    ...
    $pass=$_POST['pass'];
    $exe=$conn->query(" update user set fname='$fname',lname='$lname',email='$email',dob='$dob',contact='$contact',address='$address',password='$pass' where uid='$id' ");
    if($exe)
    {
									...
									<form class="submit-page" method="post">
										<div class="row">
											...
											<div class="col-12 col-md-6">
											  <div class="form-group">
												...
												<input class="form-control" type="text" value="<?php echo $lname;?>" name="lname" >
											  </div>
										...
										<div class="col-12 col-lg-6">
											 ...
											 <label for="birthdayDate" class="form-label">Birthday</label>
                    							<input type="date" class="form-control form-control-lg" id="birthdayDate" value="<?php echo $dob;?>" name="dob">
                 							 </div>
                                        ...
                                        <div class="col-lg-12 col-md-12">
											...
											<div class="col-md-12">
											<button class="btn btn-dark" name="edit" type="submit">Edit</button>
											</div>
