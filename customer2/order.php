...
session_start();
$id=$_SESSION['uid'];
$cat = $conn->query("SELECT * FROM cart2 where cid='$id'");
...
<!-- Mirrored from themezhub.net/odex-live/odex/order.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Mar 2023 18:17:12 GMT -->
<head>
		<meta charset="utf-8" />
										...
										<li>
											<div class="row align-items-center">
												<div class="col-4 col-md-3 col-xl-2">
													<a href="#"><img src="agency/images/<?php echo $row->img; ?>" alt="..." class="img-fluid"></a>
												</div>
												
												<div class="col">
													<!-- Title -->
													<p class="mb-2 font-size-sm font-weight-bold">
														<a class="text-body" href="#"><?php echo $row->product; ?></a> <br>
									...
									<ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
										<li class="list-group-item d-flex">
											...
											while ($row = $sum->fetch_object()) {
												$total = $total+ number_format($row->price * $row->quantity);
									...
									<div class="row">
										<div class="col-12 col-md-4">
											...
											<p class="mb-7 mb-md-0">
											 ...
											 <?php
											$add = $conn->query("SELECT * FROM final_product where user_id='$id'");
											while ($row = $add->fetch_object()) {
												echo $atype = $row->address1;
...
<!-- Mirrored from themezhub.net/odex-live/odex/order.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Mar 2023 18:17:13 GMT -->
</html>