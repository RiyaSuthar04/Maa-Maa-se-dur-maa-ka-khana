<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $exe= $conn->query("insert into subscription(tiffin_agency_id,pname,price,pimg,sdescription,ptype)values('$tid','$pname','$price','$fileName','$stext','$ptype')");
    if($exe)
    {
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center">ADD Subscription</h5>

              <!-- Multi Columns Form -->
              <form class="row g-3 " method="post"  enctype="multipart/form-data">
                <div class="col-md-6">
                  <label for="inputName5" class="form-label">Package name</label>
                  <input type="text" class="form-control" id="inputName5" name="pname">
                </div>

                <div class="col-md-6">
                  <label for="inputName5" class="form-label">Package Price</label>
                  <input type="text" class="form-control" id="inputName5" name="price">
                </div>

                <div class="col-md-12" >
                  <label for="inputName5" class="form-label">Select Image</label>
                  <input type="file" class="form-control" id="inputName5" name="pimg">
                </div>
                ...
                <div class="col-md-8">
                  <label for="inputName5" class="form-label">Package type</label>
                  <select id="inputState" class="form-select" name="ptype">
