...
session_start();
$id=$_SESSION["aid"];
$execute=$conn->query("select * from tiffin_service where id='$id' ");
if($r=$execute->fetch_object())
{
	$name=$r->tiffin_agency_name;
	$oname=$r->owner_name;
	$email=$r->email;
	$address=$r->address;
	$status=$r->status;
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                <a href="editprofile.php"><button class="nav-link" data-bs-toggle="tab" >Edit Profile</button></a> 
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Tiffin Agency Name</div>
                    <div class="col-lg-9 col-md-8"><?php echo $name;?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Owner Name</div>
                    <div class="col-lg-9 col-md-8"><?php echo $oname;?></div>
                  </div>
                  ...
                  <form method="post">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="../admin/images2/<?php echo $img;?>" alt="../admin/images/profile.jpg">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" name="tname" value="<?php echo $name;?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                       <input name="fullName" type="text" class="form-control" name="oname" value="<?php echo $oname;?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="company" type="email" class="form-control" name="email" value="<?php echo $email;?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="job" type="text" class="form-control" name="address" value="<?php echo $address;?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="country" type="text" class="form-control" name="status" value="<?php echo $status;?>">
                      </div>
                    </div>
