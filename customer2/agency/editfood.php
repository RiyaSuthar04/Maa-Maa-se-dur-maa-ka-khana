<?php
 ...
 include("common/connection.php");
  $id= $_GET["editid"];
  $result= $conn->query("select * from food_item2 where id='$id'");
  ...
  if(isset($_POST['submit']))
  {
    ...
    $exe= $conn->query("update food_item2 set fname='$fname',fprice='$fprice',sdescription='$stext',catid='$cat',subcatid='$subcat',img='$fileName' where id='$id'");
    if($exe)
    {
    ...
    {
      echo"<script>alert('data doesn't updated successfully..!!');</script>";
    }
  }
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center">Edit Food-Items</h5>
              ...
              <form class="row g-3 " method="post"  enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="fprice" value="<?php echo $row->fprice;?>">
                </div>
                ...
                <div class="col-md-12" >
                  ...
                  <input type="text" class="form-control" id="inputName5" name="stext" value="<?php echo $row->sdescription;?>">
                </div>
