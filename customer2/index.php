								...
								<div class="item">
									<div class="woo_category_box border_style rounded">
										<div class="woo_cat_thumb">
											<a href="viewcatitem2.php?editid=<?php echo $row->id; ?>&catname=<?php echo $row->cat_name; ?>"><img src="../admin/images2/<?php echo $row->img; ?>" class="img-fluid" alt="" /></a>
										</div>
										<div class="woo_cat_caption">
											<h4><a href="viewcatitem2.php?editid=<?php echo $row->id; ?>&catname=<?php echo $row->cat_name; ?>"><?php echo $row->cat_name; ?></a></h4>
										</div>
									</div>
								</div>
								<?php
								...
								<div class="item">
									<div class="offer_item">
										...
										<div class="offer_caption">
											...
											<a href="search-sidebar2.php?editid=<?php echo $r->id; ?>&viewname=<?php echo $r->tiffin_agency_name; ?>"
