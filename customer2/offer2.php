			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
						...
						<div class="row mt-5">
							<?php
							$result = $conn->query("SELECT fi.id,fi.tiffin_agency_id, ta.tiffin_agency_name AS tiffin_agency_name, ta.agency_img AS tiffin_agency_img 
							FROM subscription fi 
												...
												<li>
													<div class="input-group mb-3">
														...
														<div class="input-group-append">
															<a
																href="viewoffer2.php?editid=<?php echo $row->tiffin_agency_id; ?>&viewname=<?php echo $row->tiffin_agency_name; ?>"><input
